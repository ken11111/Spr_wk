...
**視覚的な手順**: [phase2_builtin_registration_flow.puml](../../diagrams/phase2_builtin_registration_flow.puml)

Phase 2の全体フローをPlantUML図で確認できます。図には以下の情報が含まれています：
- 既存アプリの分析手順
- Kconfig, Make.defs, Makefileの作成フロー
- **最重要**: nuttx/.configへの設定方法
- builtin登録の検証手順
- よくある失敗パターンと対処法
- 実機テストまでの流れ

**関連図**:
- [build_system_components.puml](../../diagrams/build_system_components.puml) - ビルドシステム全体像
- [config_dependencies.puml](../../diagrams/config_dependencies.puml) - CONFIG依存関係
