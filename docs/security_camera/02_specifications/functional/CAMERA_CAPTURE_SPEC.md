...
> **⚠ 整合性注記 (2026-05-03)**: 本書は要求書 v1.0 (2026-05-01) より前に作成されたため、Q16 (100ms Want が構造的天井 #1 で達成不可) や Q19 (再接続が逆効果) の発見が反映されていない。詳細は [`../quality/FUNCTIONAL_SPEC_AUDIT.md`](../quality/FUNCTIONAL_SPEC_AUDIT.md) §2 参照。
